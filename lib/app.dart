...
// ! uncomment them when you need to use Kurdish language
...
class _AppState extends ConsumerState<App> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp.router(
      ...
      locale: Locale('en'),
      localeListResolutionCallback: (locales, supportedLocales) => const Locale('en'),
      localeResolutionCallback: (locale, supportedLocales) {
        return const Locale('en'); // Always return English
      },
